...
namespace Prandtl
{
  ...
  class HLLFlux : public Prandtl::NumericalFlux
  {
  private:
  ...
  public:
                          ...
                          real_t *flux)
    {
      ...
      const real_t c1 = gasModel.sound_speed(S1) * nor_mag;
      const real_t c2 = gasModel.sound_speed(S2) * nor_mag;

      const real_t sL1 = un1 - c1;
      const real_t sL2 = un2 - c2;
      const real_t sR1 = un1 + c1;
      const real_t sR2 = un2 + c2;

      const real_t sL = (sL1 < sL2) ? sL1 : sL2;
      const real_t sR = (sR1 > sR2) ? sR1 : sR2;
      ...
      return Prandtl::Kernels::rmax(Prandtl::Kernels::rabs(sL),
                                    Prandtl::Kernels::rabs(sR));
    }
