...
namespace Prandtl
{
  ...
  real_t HLLFlux::ComputeVolumeFlux(const mfem::Vector &state1, const mfem::Vector &state2,
  ...
  real_t HLLFlux::ComputeFaceFlux(const mfem::Vector &state1, const mfem::Vector &state2,
